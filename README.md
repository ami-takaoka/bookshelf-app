...
ユーザーが書籍を登録・管理し、レビューやお気に入り、読書計画などを通して読書を管理できるWebアプリケーションを構築することを目的としています。
...
また、公開API、Laravel SanctumによるAPIトークン認証、Google Books API連携、スケジュールによるバッチ処理など、Laravelを用いたWebアプリケーション開発の実践的な機能を実装しています。
